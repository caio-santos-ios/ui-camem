...
export const ModalConfirm = ({isOpen, closeModal, confirm, title, size = "md", description = "Deseja confirmar esse registro?"}: TProp) => {
    return (
        <ModalV2 isOpen={isOpen} onClose={closeModal} title={title} size={size}>
